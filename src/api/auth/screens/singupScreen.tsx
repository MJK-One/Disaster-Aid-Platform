...
const SignUpScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="닉네임" style={styles.input} value={form.nickname} onChangeText={text => setForm({ ...form, nickname: text })} />
      <TextInput placeholder="전화번호" style={styles.input} keyboardType="phone-pad" value={form.phoneNumber} onChangeText={text => setForm({ ...form, phoneNumber: text })} />
